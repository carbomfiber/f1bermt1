...
def setTitle(_str):
    system = os.name
    if system == 'F1ber MultiTool':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} - Made By Himself")
    elif system == 'F1ber MultiTool':
